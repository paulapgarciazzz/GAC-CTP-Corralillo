  ...
  return (
    <section id="conocenos" className="py-16 bg-background">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-12 text-foreground">Visión y Misión</h2>
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <div className="bg-surface p-8 rounded-xl shadow-md hover:shadow-lg transition border border-border">
            <h3 className="text-2xl font-semibold text-primary mb-4">Visión</h3>
          ...
          <div className="bg-surface p-8 rounded-xl shadow-md hover:shadow-lg transition border border-border">
            <h3 className="text-2xl font-semibold text-primary mb-4">Misión</h3>
            <p className="text-foreground-soft leading-relaxed">
