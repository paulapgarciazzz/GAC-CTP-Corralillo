...
import { crearAgrupacion } from '../services/agrupacionService';
...
export default function ModalCrearAgrupacion({ open, onClose, onCreada }) {
    if (!open) return null;

    return <FormularioCreacion onClose={onClose} onCreada={onCreada} />;
}

function FormularioCreacion({ onClose, onCreada }) {
    ...
    const handleSubmit = async (e) => {
        ...
        const result = await crearAgrupacion(payload);
        setLoading(false);
    ...
    return (
        ...
        >
            <div
                role="dialog"
                aria-modal="true"
                aria-labelledby="titulo-modal-crear-agrupacion"
            ...
            >
                ...
                <h3 id="titulo-modal-crear-agrupacion" className="text-2xl text-center font-bold text-primary mb-6">
                    Crear agrupación
                </h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                    ...
                    >
                        ...
                        {loading ? 'Creando...' : 'Crear agrupación'}
                    </button>
                </form>
            </div>
        </div>
