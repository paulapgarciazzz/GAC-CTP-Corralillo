...
const valoresIniciales = {
    ...
    archivo_adjunto: null, archivo_adjunto_nombre: '', resena: '', id_evento: '', fecha_solicitada: '', hora_solicitada: '', comentarios: '',
};
