    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6" noValidate>
            <fieldset className="space-y-4">
                <legend className="text-lg font-semibold text-blue-950">Datos del encargado</legend>
                <div className="grid sm:grid-cols-2 gap-4">
                    <div className="space-y-1">
                        <label htmlFor="cedula" className="text-xs font-medium text-gray-600 uppercase tracking-wider block">Cédula</label>
                        ...
                        {errores.cedula && <p className="text-xs text-red-600">{errores.cedula}</p>}
                    </div>
                    <div className="space-y-1">
                        <label htmlFor="primer_nombre" className="text-xs font-medium text-gray-600 uppercase tracking-wider block">Nombre</label>
                        <input id="primer_nombre" name="primer_nombre" type="text" value={valores.primer_nombre} onChange={handleChange} required
                            ...
                            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
                        {errores.primer_nombre && <p className="text-xs text-red-600">{errores.primer_nombre}</p>}
                    </div>
                    <div className="space-y-1">
                        <label htmlFor="apellido" className="text-xs font-medium text-gray-600 uppercase tracking-wider block">Apellido</label>
                        <input id="apellido" name="apellido" type="text" value={valores.apellido} onChange={handleChange} required
                            pattern="[A-Za-zÁÉÍÓÚÑÜáéíóúñü\s]+" title="Solo letras y espacios" minLength={2} maxLength={100}
                            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
                        {errores.apellido && <p className="text-xs text-red-600">{errores.apellido}</p>}
                    </div>
                    <div className="space-y-1">
                        <label htmlFor="email" className="text-xs font-medium text-gray-600 uppercase tracking-wider block">Correo electrónico</label>
                        <input id="email" name="email" type="email" value={valores.email} onChange={handleChange} required
                            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    </div>
                    <div className="space-y-1 sm:col-span-2">
                        <label htmlFor="numero_tel" className="text-xs font-medium text-gray-600 uppercase tracking-wider block">Número de teléfono</label>
                        <input id="numero_tel" name="numero_tel" type="tel" inputMode="numeric" value={valores.numero_tel} onChange={handleChange} required
                            ...
                            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
                        {errores.numero_tel && <p className="text-xs text-red-600">{errores.numero_tel}</p>}
                    </div>
                </div>
            </fieldset>

            <fieldset className="space-y-4">
                <legend className="text-lg font-semibold text-blue-950">Datos de la agrupación</legend>
                <div className="grid sm:grid-cols-2 gap-4">
                    <div className="space-y-1">
                        <label htmlFor="nombre" className="text-xs font-medium text-gray-600 uppercase tracking-wider block">Nombre de la agrupación</label>
                    ...
                    <div className="space-y-1">
                        <label htmlFor="lugar_procedencia" className="text-xs font-medium text-gray-600 uppercase tracking-wider block">Lugar de procedencia</label>
                        <input id="lugar_procedencia" name="lugar_procedencia" type="text" value={valores.lugar_procedencia} onChange={handleChange} required
                            pattern="[A-Za-zÁÉÍÓÚÑÜáéíóúñü\s]+" title="Solo letras y espacios" minLength={2} maxLength={150}
                            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
                        {errores.lugar_procedencia && <p className="text-xs text-red-600">{errores.lugar_procedencia}</p>}
                    </div>
                    <div className="space-y-1">
                        <label htmlFor="cantidad_integrantes" className="text-xs font-medium text-gray-600 uppercase tracking-wider block">Cantidad de integrantes</label>
                    ...
                    <div className="space-y-1 sm:col-span-2">
                        <label htmlFor="resena" className="text-xs font-medium text-gray-600 uppercase tracking-wider block">Reseña (Presentaciones previas y que los caracteriza)</label>
            ...
            <fieldset className="space-y-4">
                <legend className="text-lg font-semibold text-blue-950">Datos de la solicitud</legend>
                <div className="grid sm:grid-cols-2 gap-4">
                    <div className="space-y-1">
                        <label htmlFor="fecha_asignada" className="text-xs font-medium text-gray-600 uppercase tracking-wider block">Fecha deseada de participación</label>
                    ...
                    <div className="space-y-1 sm:col-span-2">
                        <label htmlFor="comentarios" className="text-xs font-medium text-gray-600 uppercase tracking-wider block">Comentarios (en caso de requerir algun beneficio)</label>
            ...
            {error && (
                <div role="alert" className="p-3 bg-red-50 border border-red-200 rounded-lg text-red-600 text-sm text-center font-medium">
                    {error}
                </div>
            )}
            ...
            <button
                type="submit"
                disabled={loading}
                className="w-full py-3 px-4 bg-blue-950 hover:bg-blue-700 disabled:opacity-60 disabled:cursor-not-allowed text-white font-semibold rounded-xl shadow-md transition-all duration-200 flex items-center justify-center gap-2 cursor-pointer"
            >
